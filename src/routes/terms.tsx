    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main id="main-content" className="mx-auto max-w-3xl px-6 py-16">
        ...
        <Section n="02" title="Accounts and API keys">
          <p>
            You are responsible for keeping your secret key (lgk_) confidential. Every call made
            with your key is treated as made by you and is billed to your account. Rotate or revoke
            a key from your dashboard if it is exposed.
          </p>
        </Section>
        ...
        <Section n="03" title="Acceptable use">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              use Legibility to bypass authentication, paywalls, CAPTCHAs, or anti-bot controls on
              any source;
            </li>
        ...
        <Section n="04" title="Data and intellectual property">
          <p>
            Legibility extracts publicly available, factual product data (titles, identifiers,
            specs, availability, and price observations) and caches it to serve future calls. We do
            not provide product images or verbatim creative descriptions. Factual data is not owned
            by Legibility; you are granted the right to use the returned objects in your
            application.
          </p>
        </Section>
        ...
        <Section n="05" title="Accuracy: confidence and price bands">
          <p>
            ...
            high-stakes decision without your own verification. Results below the 0.7 confidence
            gate are not returned as trusted.
          </p>
        </Section>
        ...
        <Section n="07" title="Refunds">
          <p>
            ...
            case by case; contact support and we will make it right where reasonable. You can cancel
            a subscription at any time from the billing portal; access continues to the end of the
            paid period.
          </p>
        </Section>
        ...
        <Section n="08" title="Takedowns">
          <p>
            Rights holders may request removal of cached data via the takedown form. We purge
            matching cache entries promptly and can block re-caching of a source on request.
          </p>
        </Section>
        ...
        <Section n="09" title="Warranty, liability, and indemnity">
          <p>
            ...
            permitted by law, Legibility is not liable for indirect or consequential damages, and
            total liability is limited to the fees you paid in the prior three months. You agree to
        ...
        <Section n="10" title="Termination and changes">
          <p>
            Either party may stop the service at any time. We may update these terms; material
            changes will be noted here with a new date. Governing law and venue will be finalized
            with counsel before paid GA.
          </p>
        </Section>
