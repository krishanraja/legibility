...
export const Route = createFileRoute("/docs")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Legibility API and MCP server documentation." },
    ],
  }),
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-[1280px] grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-12 px-6 py-12">
        ...
        <main id="main-content" className="prose-editorial max-w-3xl">
          <Outlet />
        </main>
      </div>
      <SiteFooter />
